...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			el_gr: 'Εγκαταστήσετε αυτήν την Εφα�?μογή στήν συσκευή σας %device: %icon μετά πατάτε <strong>Π�?οσθήκη σε Αφετη�?ία</strong>.',
			en_us: 'Install this web app on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
			es_es: 'Para instalar esta app en su %device, pulse %icon y seleccione <strong>Añadir a pantalla de inicio</strong>.',
			fi_fi: 'Asenna tämä web-sovellus laitteeseesi %device: paina %icon ja sen jälkeen valitse <strong>Lisää Koti-valikkoon</strong>.',
			fr_fr: 'Ajoutez cette application sur votre %device en cliquant sur %icon, puis <strong>Ajouter à l\'écran d\'accueil</strong>.',
			he_il: '<span dir="rtl">התקן �?פליקציה זו על ה-%device שלך: הקש %icon ו�?ז <strong>הוסף למסך הבית</strong>.</span>',
			hu_hu: 'Telepítse ezt a web-alkalmazást az Ön %device-jára: nyomjon a %icon-ra majd a <strong>Főképernyőhöz adás</strong> gombra.',
			it_it: 'Installa questa applicazione sul tuo %device: premi su %icon e poi <strong>Aggiungi a Home</strong>.',
			ja_jp: '�?��?�ウェブアプリを�?��?��?��?�%device�?�インストール�?�る�?��?�%iconをタップ�?��?�<strong>ホーム画�?��?�追加</strong>を�?�ん�?��??�?��?��?�。',
			ko_kr: '%device�? 웹앱�?� 설치하려면 %icon�?� 터치 후 "홈화면�? 추가"를 선�?하세요',
			...
			ru_ru: 'У�?тановите �?то веб-приложение на ваш %device: нажмите %icon, затем <strong>Добавить в «Домой»</strong>.',
			sv_se: 'Lägg till denna webbapplikation på din %device: tryck på %icon och därefter <strong>Lägg till på hemskärmen</strong>.',
			th_th: 'ติดตั้งเว็บ�?อพฯ นี้บน %device ของคุณ: �?ตะ %icon �?ละ <strong>เพิ่มที่หน้าจอโฮม</strong>',
			tr_tr: '%device için bu uygulamayı kurduktan sonra %icon simgesine dokunarak <strong>Ev Ekranına Ekle</strong>yin.',
			zh_cn: '您�?�以将此应用程�?安装到您的 %device 上。请按 %icon 然�?�点选<strong>添加至主�?幕</strong>。',
			zh_tw: '您�?�以將此應用程�?安�?到您的 %device 上。請按 %icon 然後點�?�<strong>加入主畫�?�螢幕</strong>。'
		};
